#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Oil & Gas / Combustion Floor
============================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Oil & Gas (Combustion Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "oil_gas",
    "domain_name": "Oil & Gas",
    "theorem": "Combustion Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 3500.0,
    "channels": {
        "C1_co2_climate_damages": {
            ...
            "high": 4218.0,
            "weight": 0.51,
            "description": "CO\u2082 combustion damages at EPA SCC=$190/tCO\u2082. 18.5Gt CO\u2082/yr \u00d7 $190 = $3.515T. Sources: EPA 2023 SCC, GIVE model (Rennert et al. 2022), IEA WEO."
        },
        "C2_methane_operational": {
            ...
            "high": 185.0,
            "weight": 0.019,
            "description": "Operational methane leakage at SC-CH\u2084=$1,600/t. 80-130Mt CH\u2084/yr. IEA: 75% eliminable at zero net cost. Sources: EPA SC-CH\u2084, IEA Methane Tracker, NOAA."
        },
        "C3_air_pollution_health": {
            ...
            "high": 1500.0,
            "weight": 0.142,
            "description": "O&G share of $2.9T global fossil fuel air pollution cost (CREA). 7,500 US deaths from production alone. Cancer Alley: 47\u00d7 EPA cancer threshold. Sources: CREA, BU/UNC 2023, Lancet."
        },
        "C4_oil_spills_ecosystem": {
            ...
            "high": 200.0,
            "weight": 0.017,
            "description": "Oil spills, pipeline leaks, ecosystem degradation, produced water contamination. Deepwater Horizon alone $65B+. Chronic low-level contamination. Sources: NOAA, API spill data, ITOPF."
        },
        "C5_governance_resource_curse": {
            ...
            "high": 400.0,
            "weight": 0.04,
            "description": "Resource curse GDP penalty (1.5% \u00d7 $7T OPEC+ GDP = $105B), $452.6M Big Five lobbying 2011-2021, $7T global subsidies, API 1998 'Roadmap' disinformation. Sources: IMF, OpenSecrets, API."
        },
        "C6_stranded_asset_risk": {
            ...
            "high": 1000.0,
            "weight": 0.09,
            "description": "Stranded assets: $16.1T cumulative over 25yr transition (annualized $644B). 60% valuation haircut under NZE ($2.1T market cap). Sources: IEA NZE, IMF, Carbon Tracker."
        }
    },
    "impossibility_floor": 1.0
}
